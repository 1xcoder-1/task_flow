...
export const BoardLink = ({ children, onClick, ...props }: BoardLinkProps) => {
  ...
  return (
    <>
      ...
      {isPending && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-[#090d16]/60 backdrop-blur-md transition-colors duration-200" role="status" aria-label="Opening board">
